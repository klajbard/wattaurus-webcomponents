...
class List extends LitElement$1 {
  constructor() {
    super();
    this.list = [];
    this.plain;
...
class ListElem extends LitElement$2 {
  constructor() {
    super();
    this.logo;
    this.plain;
...
const render$1$3 = (result, container, options) => {
    ...
    // fragment that is reused since nested renders can occur synchronously.
    const renderContainer = firstScopeRender ? document.createDocumentFragment() : container;
    render$6(result, renderContainer, Object.assign({ templateFactory: shadyTemplateFactory$4(scopeName) }, options));
    // When performing first scope render,
    // (1) We've rendered into a fragment so that there's a chance to
    // `prepareTemplateStyles` before sub-elements hit the DOM
    // (which might cause them to render based on a common pattern of
 ...
 * @nocollapse
 */
LitElement$4.render = render$1$3;

class Button extends LitElement$4 {
  constructor() {
    super();
    this.disabled;
    this.outline;
...
const render$1$4 = (result, container, options) => {
    ...
    // fragment that is reused since nested renders can occur synchronously.
    const renderContainer = firstScopeRender ? document.createDocumentFragment() : container;
    render$7(result, renderContainer, Object.assign({ templateFactory: shadyTemplateFactory$5(scopeName) }, options));
    // When performing first scope render,
    // (1) We've rendered into a fragment so that there's a chance to
    // `prepareTemplateStyles` before sub-elements hit the DOM
    // (which might cause them to render based on a common pattern of
 ...
 * @nocollapse
 */
LitElement$5.render = render$1$4;

class LinkIcon extends LitElement$5 {
  constructor() {
    super();
    this.href = '';
    this.title = '';
...
class Header extends LitElement$3 {
  constructor() {
    super();
    this.component = '';
    this.showBack;
